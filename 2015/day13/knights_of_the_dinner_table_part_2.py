...
and your happiness wouldn't really go up or down regardless
of who you sit next to. You assume everyone else would be just
...
# add myself to the set of people, and set all reactions to 0
people.add('myself')
reactions['myself'] = {}
for person in people:
    reactions['myself'][person] = 0
    reactions[person]['myself'] = 0
